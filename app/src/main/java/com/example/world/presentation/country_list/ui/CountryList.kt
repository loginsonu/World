package com.example.world.presentation.country_list.ui
...
import com.example.world.presentation.country_list.viewmodel.CountryViewModel
...
import com.example.world.presentation.common.navigation.Screens
...
import com.example.world.presentation.country_list.ui.components.CountryItem
        ...
        CountryListLocal(
            state = CountryState(
                countryListResponse = CountryListResponse(
                    listCountry = listOf(
                        com.example.world.domain.model.CountryItem(countryCode = "In", countryName = "India")
                    ))
            ),
